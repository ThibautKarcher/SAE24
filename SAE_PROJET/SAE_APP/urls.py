...
urlpatterns = [
    ...
    path('APP/export/capteur/', views.export_capteur_csv, name='export_capteur_csv'),
    path('APP/export/donnee/', views.export_donnee_csv, name='export_donnee_csv'),
    path('APP/graphique/', views.graphique_donnees, name='graphique_donnees'),
]
